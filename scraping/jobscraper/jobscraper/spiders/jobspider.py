...
class IndeedJobSpider(scrapy.Spider):
    ...
    def get_indeed_search_url(self, keyword, location, offset=0):
        ...
        return "https://ca.indeed.com/jobs?q=software+engineer+intern&l=Canada&radius=50&start=10&vjk=8b13aa2c0179f411"


    def start_requests(self):
        keyword_list = ['intern']
        location_list = ['ottawa']
    ...
    def parse_job(self, response):
        ...
        if script_tag is not None:
            ...
            yield {
                ...
                'href': json_blob["viewJobButtonLinkContainerModel"]["viewJobButtonLinkModel"].get('href'),
                'age': json_blob["jobMetadataFooterModel"].get("age"),
            }